...
public class MainClass {
			...
			while (chosen != 4) {
				...
				try {
					...
					case 1:
						...
						System.out.printf("Lista contacte:\n");
						afisContact(contactRep);
						break;
					case 2:
	...
	private static void afisContact(RepositoryContact repositoryContact) {
		List<Contact> contacte = repositoryContact.getContacts();
